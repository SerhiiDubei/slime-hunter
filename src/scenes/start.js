...
export function createStartScene() {
    scene("start", () => {
        ...
        add([rect(3, H), pos(0, 0), color(100, 65, 30), z(50)]);
        add([rect(3, H), pos(W - 3, 0), color(100, 65, 30), z(50)]);
        ...
        // Separator
        add([rect(300, 2), pos(W / 2, 220), anchor("center"), color(80, 60, 45)]);
        ...
        // Preview sprites
        const spriteY = 340;
        const pp = add([sprite("player"), pos(W / 2 - 120, spriteY), anchor("center"), scale(1.3), z(5)]);
        const pe = add([sprite("slime"), pos(W / 2, spriteY), anchor("center"), scale(1.1), z(5)]);
        const pb = add([sprite("bossKing"), pos(W / 2 + 120, spriteY), anchor("center"), scale(0.8), z(5)]);
        
        add([text("HERO", { size: 10 }), pos(W / 2 - 120, spriteY + 35), anchor("center"), color(100, 200, 150)]);
        add([text("ENEMY", { size: 10 }), pos(W / 2, spriteY + 35), anchor("center"), color(200, 100, 100)]);
        add([text("BOSS", { size: 10 }), pos(W / 2 + 120, spriteY + 35), anchor("center"), color(255, 150, 100)]);
        ...
        onTouchStart((touchPos) => {
            const btnLeft = W / 2 - 150;
            const btnRight = W / 2 + 150;
